...
contract ERC721BridgelessMinting is ERC721 {
     ...
     * @dev This function overrides the one from the base ERC721 contract to ensure that the maxBalance is always returned, since all slots are allocated on deploy, and tradable.
     ...
     * @dev This function returns the same value regardless of whether the token has been transferred once or more times.
     * @dev Use ownerOf() to query current owner of an token, as opposed to the init owner.
